...
async def main():
    ...
    ds = bm.multiplex_socket(['btcusdt@depth20@100ms', 'btcusdt@miniTicker', 'ethusdt@miniTicker'])
    ...
    async with ds as tscm:
        ...
        while True:
            ...
            if i > 1 :
                if res['stream'] == 'btcusdt@depth20@100ms':
            ...
            if int(time.time()) > start_loop + intervals: #what happens after 'intervals' seconds
                ...
                filenum = filenum + 1 
                filename1 = 'C:\\firaas\\code\\files2\\productbook{}.txt'
                filename2 = 'C:\\firaas\\code\\files2\\BTC-info{}.txt'
                filename3 = 'C:\\firaas\\code\\files2\\ETH-info{}.txt'
